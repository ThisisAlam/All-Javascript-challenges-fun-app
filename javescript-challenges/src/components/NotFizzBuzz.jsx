...
export default function NotFizzBuzz() {
    function notFizzBuzzFunction(...number) {
        return <ul>{
            number.map(num=>{
                if(num % 3 === 0){
                    return <li>{"Player" + {num}}: "Vacation!"</li>;
                }
                else if(num % 5 === 0){
                    return <li>{"Player" + {num}}: "$100,000 bonus!"</li>;
                }
                else if(num % 3 === 0 && num % 5 === 0){
                    return <li>{"Player" + {num}}: "JACKPOT! 1 Million and a Yacht!"</li>;
                } 
                else{
                    return <li>{"Player" + {num}}: "Better luck next time! 🙁"</li>;
                }
            })
        }</ul>
    }
